...
from src.services.computers.computers_views import computer_ns, computer_rights_ns, computer_rights_resourece_ns
from src.services.power.power_views import devicepower_ns
all_namespaces = [user_ns, auth_ns, admin_ns, computer_ns, devicepower_ns, computer_rights_ns, computer_rights_resourece_ns]
